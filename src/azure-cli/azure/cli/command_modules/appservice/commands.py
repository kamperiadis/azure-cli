...
def load_command_table(self, _):
    ...
    with self.command_group('functionapp vnet-integration') as g:
        g.custom_command('add', 'add_functionapp_vnet_integration', validator=validate_add_vnet, validator=validate_functionapp_on_containerapp_vnet, exception_handler=ex_handler_factory())
