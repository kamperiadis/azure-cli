...
class FunctionAppManagedEnvironment(LiveScenarioTest):
    ...
    def test_functionapp_create_with_appcontainer_managed_environment_vnet_config_error(self, resource_group, storage_account):
        ...
        self.cmd(
            'functionapp create -g {} -n {} -p {} -s {} --vnet {} --subnet {}  --environment {} --runtime dotnet --functions-version 4'
            .format(resource_group, functionapp_name, plan_name, storage_account, vnet_name, subnet_name, managed_environment_name), expect_failure=True)
